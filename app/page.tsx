  ...
  return (
    <>
      <style>{`
        ...
        .section-line::after {
          content:''; display:block; height:2px; margin-top:12px;
          background: linear-gradient(90deg,#D4AF37,transparent);
          animation: lineGrow 1s 0.3s both;
        }

        .floating-badge { animation: floatBadge 3s ease-in-out infinite; }

        .img-hover { overflow:hidden; }
        .img-hover img { transition: transform 0.7s cubic-bezier(0.22,1,0.36,1), filter 0.5s; filter:brightness(0.8) saturate(0.85); }
        ...
        .glow-card:hover { transform: translateY(-10px); box-shadow: 0 30px 80px rgba(212,175,55,0.18), 0 0 0 1px rgba(212,175,55,0.3); }
        ...
        .dot-indicator { transition: all 0.3s cubic-bezier(0.22,1,0.36,1); }
        .dot-indicator:hover { transform:scale(1.5); }
      `}</style>
      ...
      <section ref={heroRef} style={{ minHeight:"100vh", position:"relative", overflow:"hidden", display:"flex", alignItems:"center" }}>
        ...
        <div style={{ maxWidth:1280, margin:"0 auto", padding:"130px 5% 110px",
          ...
          <h1 style={{ fontFamily:"'Anton',sans-serif", lineHeight:0.9, marginBottom:28, letterSpacing:"0.01em" }}>
            <div className="h1-line hero-line-1" style={{ fontSize:"clamp(4rem,11vw,9.5rem)", color:"#F0F0F0" }}>
              <span>WAGE WAR</span>
            </div>
            <div className="h1-line hero-line-2" style={{ fontSize:"clamp(4rem,11vw,9.5rem)", color:"#F0F0F0" }}>
              <span>AGAINST</span>
            </div>
            <div className="h1-line hero-line-3" style={{ fontSize:"clamp(4rem,11vw,9.5rem)" }}>
              <span className="gold-shimmer">MEDIOCRITY.</span>
            </div>
          </h1>

          <div style={{ width:80, height:3, background:"linear-gradient(90deg,#D4AF37,transparent)", marginBottom:28 }} />

          <p className="hero-sub" style={{ fontSize:"1.1rem", color:"rgba(240,240,240,0.6)",
            maxWidth:480, lineHeight:1.85, marginBottom:44 }}>
          ...
          <div className="hero-cta" style={{ display:"flex", gap:16, flexWrap:"wrap", marginBottom:56 }}>
            <Link href="/join" className="btn-primary" style={{ fontSize:"1.05rem", padding:"16px 40px" }}>
              Start Free Trial →
            </Link>
            <Link href="/membership" className="btn-outline" style={{ fontSize:"1.05rem", padding:"15px 40px" }}>
              View Plans
            </Link>
          </div>
          ...
          <div className="hero-dots" style={{ display:"flex", gap:8, alignItems:"center" }}>
            {HERO_IMAGES.map((_, i) => (
              <button key={i} className="dot-indicator" onClick={() => setCurrent(i)}
                style={{ width: i === current ? 32 : 8, height:8, borderRadius:4, padding:0, border:"none", cursor:"pointer",
        ...
        {/* Floating badge */}
        <div className="floating-badge" style={{ position:"absolute", bottom:80, right:"5%", zIndex:4,
        ...
        <div style={{ position:"absolute", bottom:0, left:0, right:0, zIndex:5,
          ...
          <div className="ticker-inner">
            {["STRENGTH","POWER","DISCIPLINE","BARBELL CARTEL","WAGE WAR","BROOKEFIELD","NO EXCUSES","LIFT HEAVY",
              ...
              <span key={i} style={{ fontFamily:"'Anton',sans-serif", fontSize:"0.88rem", letterSpacing:"0.22em", color:"#0A0A0A" }}>
      ...
      {/* ── WHY BARBELL CARTEL ────────────────────────────── */}
      <section className="noise-bg section-overlay" style={{ padding:"110px 5%", background:"#0A0A0A", position:"relative" }}>
        <div style={{ maxWidth:1280, margin:"0 auto", display:"grid",
          gridTemplateColumns:"repeat(auto-fit, minmax(300px,1fr))", gap:72, alignItems:"center", position:"relative", zIndex:1 }}>
          <div>
            <Reveal variant="fadeLeft">
              <div className="section-tag">Why We're Different</div>
              <h2 className="section-title section-line">NOT YOUR<br /><span style={{ color:"#D4AF37" }}>AVERAGE GYM.</span></h2>
            </Reveal>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:14 }}>
            {[["🏋️","Competition Barbells","Calibrated plates, specialty bars, proper powerlifting setup."],
              ...
              <Reveal key={title} variant="scaleUp" delay={i * 80}>
                <div className="glow-card" style={{ background:"#111", border:"1px solid rgba(212,175,55,0.12)",
                  padding:"22px 18px", cursor:"default", height:"100%" }}>
                  ...
                  <div style={{ fontFamily:"'Barlow Condensed',sans-serif", fontWeight:700, fontSize:"0.95rem",
                    color:"#F0F0F0", letterSpacing:"0.06em", marginBottom:6 }}>{title}</div>
      ...
      <div style={{ position:"relative", height:320, overflow:"hidden" }}>
        <div style={{ position:"absolute", inset:0,
          transform: `translateY(${scrollY * 0.15 - 80}px)`,
          transition:"transform 0.1s linear" }}>
          <img src={HERO_IMAGES[3]} alt="" style={{ width:"100%", height:"140%", objectFit:"cover",
        ...
        <div style={{ position:"absolute", inset:0, display:"flex", alignItems:"center",
          ...
          <Reveal variant="fadeIn">
            <div style={{ fontFamily:"'Barlow Condensed',sans-serif", fontSize:"0.75rem",
              letterSpacing:"0.35em", color:"#D4AF37", textTransform:"uppercase", textAlign:"center" }}>
              Brookefield's Premier Strength Gym
            </div>
            <div style={{ fontFamily:"'Anton',sans-serif", fontSize:"clamp(2rem,6vw,4.5rem)",
              color:"#F0F0F0", textAlign:"center", lineHeight:1, marginTop:10,
      ...
      {/* ── GYM GALLERY ───────────────────────────────────── */}
      <section className="section-overlay" style={{ padding:"100px 5%", background:"#111", position:"relative" }}>
            ...
            <Reveal variant="fadeRight">
              <div className="img-hover border-animated" style={{ height:240, position:"relative", cursor:"pointer" }}
                ...
                <div style={{ position:"absolute", inset:0, display:"flex", alignItems:"center",
                  ...
                  <div style={{ fontFamily:"'Anton',sans-serif", fontSize:"2rem", color:"#D4AF37" }}>BOOK A TOUR</div>
                  <div style={{ fontSize:"0.8rem", color:"rgba(255,255,255,0.6)", letterSpacing:"0.15em" }}>WALK THE FLOOR →</div>
                </div>
              </div>
            </Reveal>
          </div>
      ...
      <section className="noise-bg section-overlay" style={{ padding:"110px 5%", background:"#0A0A0A", position:"relative" }}>
        <div style={{ maxWidth:1200, margin:"0 auto", position:"relative", zIndex:1 }}>
          <Reveal variant="fadeUp" style={{ textAlign:"center", marginBottom:64 }}>
            ...
            {PLANS.map((p, i) => (
              <Reveal key={i} variant="fadeUp" delay={i * 120}>
                <div className="plan-pop" style={{
                  ...
                  <div style={{ height:1, background: p.popular ? "rgba(212,175,55,0.2)" : "rgba(212,175,55,0.08)", marginBottom:28 }} />
                  {p.features.map((f, j) => (
                    <div key={j} style={{ display:"flex", gap:12, marginBottom:14, alignItems:"flex-start" }}>
                      <span style={{ color: p.popular ? "#D4AF37" : "#8B0000", flexShrink:0, fontSize:"1rem" }}>✓</span>
      ...
      <div style={{ position:"relative", height:260, overflow:"hidden" }}>
        <div style={{ position:"absolute", inset:0,
          transform:`translateY(${scrollY * 0.12 - 60}px)` }}>
        ...
        <div style={{ position:"absolute", inset:0,
          background:"linear-gradient(to bottom, #0A0A0A, transparent 30%, transparent 70%, #111 100%)" }} />
        <div style={{ position:"absolute", inset:0, display:"flex", alignItems:"center",
          justifyContent:"center", gap:60, flexWrap:"wrap", padding:"0 5%" }}>
          {[["500+","Active Members"],["3","Expert Coaches"],["PRs","Broken Daily"],["5★","Google Rated"]].map(([v,l]) => (
            <Reveal key={l} variant="scaleUp">
              <div style={{ textAlign:"center" }}>
                <div style={{ fontFamily:"'Anton',sans-serif", fontSize:"clamp(2rem,5vw,3.5rem)",
                  color:"#D4AF37", lineHeight:1 }}>{v}</div>
                <div style={{ fontSize:"0.75rem", color:"#666", letterSpacing:"0.18em",
                  textTransform:"uppercase", marginTop:6 }}>{l}</div>
              </div>
            </Reveal>
          ))}
        </div>
      ...
      <section className="section-overlay" style={{ padding:"100px 5%", background:"#111" }}>
        <div style={{ maxWidth:1280, margin:"0 auto" }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-end",
            ...
            <Reveal variant="fadeRight">
              <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                {[...Array(5)].map((_,i) => <span key={i} style={{ color:"#FFD700", fontSize:20 }}>★</span>)}
          ...
          <Reveal variant="fadeUp" delay={200} style={{ textAlign:"center", marginTop:40 }}>
      ...
      {/* ── FULL WIDTH CTA ────────────────────────────────── */}
      <section style={{ position:"relative", overflow:"hidden", padding:"130px 5%", textAlign:"center" }}>
        <div style={{ position:"absolute", inset:0 }}>
          <img src={HERO_IMAGES[5]} alt="" style={{ width:"100%", height:"100%", objectFit:"cover",
        ...
        <div style={{ position:"absolute", inset:0, overflow:"hidden", pointerEvents:"none" }}>
          {[0,1,2].map(i => (
            <div key={i} style={{ position:"absolute", left:"-50%", top:`${20 + i*30}%`,
              width:"200%", height:1, background:`rgba(212,175,55,${0.06 - i*0.015})`,
        ...
        <div style={{ position:"relative", zIndex:2, maxWidth:700, margin:"0 auto" }}>
          <Reveal variant="fadeUp">
            ...
            <h2 style={{ fontFamily:"'Anton',sans-serif",
              fontSize:"clamp(2.8rem,7vw,5.5rem)", color:"#F0F0F0",
              lineHeight:0.95, marginBottom:20 }}>
              READY TO <span style={{ color:"#D4AF37" }}>WAGE WAR?</span>
            </h2>
            <p style={{ color:"#888", fontSize:"1.1rem", marginBottom:48, lineHeight:1.8 }}>
          ...
          <Reveal variant="scaleUp" delay={200}>
            <div style={{ display:"flex", gap:16, justifyContent:"center", flexWrap:"wrap" }}>
              <Link href="/join" className="btn-primary" style={{ fontSize:"1.1rem", padding:"17px 44px" }}>
                Start Free Trial →
              </Link>
              <Link href="/contact" className="btn-outline" style={{ fontSize:"1.1rem", padding:"16px 44px" }}>
                Get In Touch
              </Link>
            </div>
          </Reveal>
